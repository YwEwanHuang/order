...
- [x] T-013 增加 Dockerfile、`.dockerignore`、测试（根 Dockerfile 为唯一部署入口，端口 80）
...
- [x] T-021 建立 MySQL `dishes` 表、索引、数据访问层和 7 条初始菜品（本地 Mock 测试完成，真实云托管 MySQL 集成待验证）
...
| M1 | 5 | 4（T-010,T-011,T-012,T-013） | 0 | 1（T-014 依赖后端 API） |
